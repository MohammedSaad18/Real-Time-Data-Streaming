...
### Documentation
you may find the following examples and documentation helpful in completing this assignment:
...
| Service | Docker URL | Username | Password |
| --- | --- | --- | --- |
| Public Transit Status  | n/a | ||
| Landoop Kafka Connect UI  | http://connect-ui:8084 |
| Landoop Kafka Topics UI  | http://topics-ui:8085 |
| Landoop Schema Registry UI  | http://schema-registry-ui:8086 |
| Kafka  | PLAINTEXT://kafka0:9092,PLAINTEXT://kafka1:9093,PLAINTEXT://kafka2:9094 |
| REST Proxy  | http://rest-proxy:8082/ |
| Schema Registry  | http://schema-registry:8081/ |
| Kafka Connect  | http://kafka-connect:8083 |
| KSQL  | http://ksql:8088 |
| PostgreSQL | `jdbc:postgresql://postgres:5432/cta` | `cta_admin` | `chicago` |
