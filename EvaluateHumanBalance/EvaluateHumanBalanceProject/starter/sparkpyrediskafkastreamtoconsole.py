...
redisServerRawStreamDF = redisServerRawStreamDF.selectExpr("cast(value as string) value")
...
redisServerRawStreamDF.withColumn("value", from_json("value", RedisServerSchema))\
